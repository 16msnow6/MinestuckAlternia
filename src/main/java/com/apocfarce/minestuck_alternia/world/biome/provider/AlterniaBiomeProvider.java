...
import main.java.com.apocfarce.minestuck_alternia.world.biome.layer.AlterniaLayerUtil;
...
public class AlterniaBiomeProvider extends BiomeProvider {
   ...
   public AlterniaBiomeProvider(/*OverworldBiomeProviderSettings*/AlterniaBiomeSettings settingsProvider) {
...
//    OverworldGenSettings overworldgensettings = settingsProvider.getGeneratorSettings();
      GenLayer[] agenlayer = AlterniaLayerUtil.buildAlterniaProcedure(worldinfo.getSeed(), worldinfo.getTerrainType(), alterniagensettings);
