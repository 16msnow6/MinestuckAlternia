package main.java.com.apocfarce.minestuck_alternia.world.biome.layer;
...
public class AlterniaLayerUtil {
   ...
   public static <T extends IArea, C extends IContextExtended<T>> ImmutableList<IAreaFactory<T>> buildAlterniaProcedure(WorldType worldTypeIn, AlterniaGenSettings settings, LongFunction<C> contextFactory) {
      ...
      i = getModdedBiomeSize(worldTypeIn, i);
	      ...
	      lvt_7_1_ = GenLayerRiverInit.INSTANCE.apply((IContextExtended<T>)contextFactory.apply(100L), lvt_7_1_);
...
//	      IAreaFactory<T> lvt_8_1_ = worldTypeIn.getBiomeLayer(iareafactory, settings, contextFactory);
	      ...
	      lvt_7_1_ = GenLayerRiver.INSTANCE.apply((IContextExtended<T>)contextFactory.apply(1L), lvt_7_1_);
	      lvt_7_1_ = GenLayerSmooth.INSTANCE.apply((IContextExtended<T>)contextFactory.apply(1000L), lvt_7_1_);
   ...
   public static GenLayer[] buildAlterniaProcedure(long seed, WorldType typeIn, AlterniaGenSettings settings) {
      int i = 1;
      int[] aint = new int[1];
      ImmutableList<IAreaFactory<LazyArea>> immutablelist = buildAlterniaProcedure(typeIn, settings, (p_202825_3_) -> {
         ++aint[0];
